...
$(ObjDir)/desDEC_tb.c_pre.c.tb.o : desDEC_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) desDEC_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/desDecrypt.c_pre.c.tb.o : desDecrypt.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) desDecrypt.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/desEncrypt.c_pre.c.tb.o : desEncrypt.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) desEncrypt.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
