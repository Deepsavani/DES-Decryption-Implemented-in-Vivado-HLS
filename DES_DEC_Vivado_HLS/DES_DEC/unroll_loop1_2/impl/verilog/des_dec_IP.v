...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module des_dec_IP_rom (
...
initial begin
    $readmemh("./des_dec_IP_rom.dat", ram0);
    $readmemh("./des_dec_IP_rom.dat", ram1);
    $readmemh("./des_dec_IP_rom.dat", ram2);
    $readmemh("./des_dec_IP_rom.dat", ram3);
    $readmemh("./des_dec_IP_rom.dat", ram4);
    $readmemh("./des_dec_IP_rom.dat", ram5);
    $readmemh("./des_dec_IP_rom.dat", ram6);
    $readmemh("./des_dec_IP_rom.dat", ram7);
    $readmemh("./des_dec_IP_rom.dat", ram8);
    $readmemh("./des_dec_IP_rom.dat", ram9);
    $readmemh("./des_dec_IP_rom.dat", ram10);
    $readmemh("./des_dec_IP_rom.dat", ram11);
    $readmemh("./des_dec_IP_rom.dat", ram12);
    $readmemh("./des_dec_IP_rom.dat", ram13);
    $readmemh("./des_dec_IP_rom.dat", ram14);
    $readmemh("./des_dec_IP_rom.dat", ram15);
end
...
des_dec_IP_rom des_dec_IP_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
