...
// ==============================================================
# 1 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c"
# 1 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 2
...
# 2 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 2
...
# 3 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 2
...
# 4 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 2
...
# 5 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 2
# 1 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.H" 1
uint64_t des_dec(uint64_t input, uint64_t key);
# 6 "C:/Users/deeps/OneDrive/Desktop/AHD_FINALS/desDecrypt.c" 2
    ...
    static char PI[] = {
        ...
        static char PC2[] = {
            ...
            static char S[8][64] = {{
               ...
               Pipeline_loop4:for (i = 0; i < 16; i++) {
                int abc = 0;

                   s_input = 0;

                   loop4_1:for (j = 0; j< 48; j++) {
                       s_input <<= 1+abc;
                   ...
                   s_input = s_input ^ sub_key[15-i];
                           ...
                           loop4_2:for (j = 0; j < 8; j++) {




                               row = (char) ((s_input & (0x0000840000000000 >> ((j << 1) + (j << 2)))) >> 42-((j << 1) + (j << 2)));
                               row = (row >> 4) | (row & 0x01);

                               column = (char) ((s_input & (0x0000780000000000 >> ((j << 1) + (j << 2)))) >> 43-((j << 1) + (j << 2)));

                               s_output <<= 4;
                               s_output |= (uint32_t) (S[j][(row << 4) + column] & 0x0f);

                           }

                           f_function_res = 0;

                           loop4_3:for (j = 0; j < 32; j++) {
                               f_function_res <<= 1;
