...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "des_dec.autotvin.dat"
	set constFileTvOut       "des_dec.autotvout.dat"
	set constFileHdlTvIn     "des_dec.autohdltvin.dat"
	set constFileHdlTvOut    "des_dec.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
