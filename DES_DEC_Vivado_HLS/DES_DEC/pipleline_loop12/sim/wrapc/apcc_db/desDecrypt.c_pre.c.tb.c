...
signed long long des_dec(signed long long llvm_cbe_input, signed long long llvm_cbe_key) {
  ...
  unsigned long long llvm_cbe_tmp__157__PHI_TEMPORARY;
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge327 = phi i32 [ %%166, %%164 ], [ 0, %%92  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_storemerge327_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%94 = phi i32 [ %%95, %%164 ], [ %%16, %%92  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_408_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%95 = phi i32 [ %%165, %%164 ], [ %%17, %%92  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_409_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%96 = phi i32 [ %%151, %%164 ], [ 0, %%92  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_410_count);
...
llvm_cbe_tmp__180:
if (AESL_DEBUG_TRACE)
printf("\n  %%165 = xor i32 %%162, %%94, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_628_count);
  llvm_cbe_tmp__151 = (unsigned int )llvm_cbe_tmp__149 ^ llvm_cbe_tmp__84;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__151);
if (AESL_DEBUG_TRACE)
printf("\n  %%166 = add nsw i32 %%storemerge327, 1, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_630_count);
  llvm_cbe_tmp__152 = (unsigned int )((unsigned int )(llvm_cbe_storemerge327&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__152&4294967295ull)));
  if (((llvm_cbe_tmp__152&4294967295U) == (16u&4294967295U))) {
    goto llvm_cbe_tmp__181;
  } else {
    llvm_cbe_storemerge327__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__152;   /* for PHI node */
    llvm_cbe_tmp__84__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__85;   /* for PHI node */
    llvm_cbe_tmp__85__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__151;   /* for PHI node */
    llvm_cbe_tmp__86__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__138;   /* for PHI node */
    goto llvm_cbe__2e_preheader21;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge718 = phi i32 [ %%163, %%.preheader ], [ 0, %%116  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_storemerge718_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%153 = phi i32 [ %%162, %%.preheader ], [ 0, %%116  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_587_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%154 = shl i32 %%153, 1, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_588_count);
  llvm_cbe_tmp__141 = (unsigned int )llvm_cbe_tmp__140 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__141);
if (AESL_DEBUG_TRACE)
printf("\n  %%155 = sext i32 %%storemerge718 to i64, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_593_count);
  llvm_cbe_tmp__142 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge718);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__142);
if (AESL_DEBUG_TRACE)
printf("\n  %%156 = getelementptr inbounds [32 x i8]* @aesl_internal_des_dec.P, i64 0, i64 %%155, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_594_count);
  llvm_cbe_tmp__143 = ( char *)(&aesl_internal_des_dec_OC_P[(((signed long long )llvm_cbe_tmp__142))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__142) < 32)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_des_dec.P' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%157 = load i8* %%156, align 1, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_595_count);
  llvm_cbe_tmp__144 = (unsigned char )*llvm_cbe_tmp__143;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__144);
if (AESL_DEBUG_TRACE)
printf("\n  %%158 = sext i8 %%157 to i32, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_596_count);
  llvm_cbe_tmp__145 = (unsigned int )((signed int )( char )llvm_cbe_tmp__144);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__145);
if (AESL_DEBUG_TRACE)
printf("\n  %%159 = sub nsw i32 32, %%158, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_597_count);
  llvm_cbe_tmp__146 = (unsigned int )((unsigned int )(32u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__145&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__146&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%160 = lshr i32 %%151, %%159, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_598_count);
  llvm_cbe_tmp__147 = (unsigned int )((unsigned int )(((unsigned int )(llvm_cbe_tmp__138&4294967295ull)) >> ((unsigned int )(llvm_cbe_tmp__146&4294967295ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__147&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%161 = and i32 %%160, 1, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_599_count);
  llvm_cbe_tmp__148 = (unsigned int )llvm_cbe_tmp__147 & 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__148);
if (AESL_DEBUG_TRACE)
printf("\n  %%162 = or i32 %%161, %%154, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_600_count);
  llvm_cbe_tmp__149 = (unsigned int )llvm_cbe_tmp__148 | llvm_cbe_tmp__141;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__149);
if (AESL_DEBUG_TRACE)
printf("\n  %%163 = add nsw i32 %%storemerge718, 1, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_605_count);
  llvm_cbe_tmp__150 = (unsigned int )((unsigned int )(llvm_cbe_storemerge718&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__150&4294967295ull)));
  if (((llvm_cbe_tmp__150&4294967295U) == (32u&4294967295U))) {
    goto llvm_cbe_tmp__180;
  } else {
    llvm_cbe_storemerge718__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__150;   /* for PHI node */
    llvm_cbe_tmp__140__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__149;   /* for PHI node */
...
llvm_cbe_tmp__182:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge620 = phi i32 [ 0, %%110 ], [ %%152, %%116  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_storemerge620_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%117 = phi i32 [ %%96, %%110 ], [ %%151, %%116  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_511_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%118 = shl i32 %%storemerge620, 1, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_512_count);
  llvm_cbe_tmp__105 = (unsigned int )llvm_cbe_storemerge620 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__105);
if (AESL_DEBUG_TRACE)
printf("\n  %%119 = shl i32 %%storemerge620, 2, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_513_count);
  llvm_cbe_tmp__106 = (unsigned int )llvm_cbe_storemerge620 << 2u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__106);
if (AESL_DEBUG_TRACE)
printf("\n  %%120 = add nsw i32 %%118, %%119, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_514_count);
  llvm_cbe_tmp__107 = (unsigned int )((unsigned int )(llvm_cbe_tmp__105&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__106&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__107&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%121 = zext i32 %%120 to i64, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_515_count);
  llvm_cbe_tmp__108 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__107&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__108);
if (AESL_DEBUG_TRACE)
printf("\n  %%122 = lshr i64 145135534866432, %%121, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_516_count);
  llvm_cbe_tmp__109 = (unsigned long long )((unsigned long long )(((unsigned long long )(145135534866432ull&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__108&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__109&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%123 = and i64 %%122, %%115, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_517_count);
  llvm_cbe_tmp__110 = (unsigned long long )llvm_cbe_tmp__109 & llvm_cbe_tmp__103;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__110);
if (AESL_DEBUG_TRACE)
printf("\n  %%124 = sub nsw i32 42, %%120, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_518_count);
  llvm_cbe_tmp__111 = (unsigned int )((unsigned int )(42u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__107&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__111&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%125 = zext i32 %%124 to i64, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_519_count);
  llvm_cbe_tmp__112 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__111&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__112);
if (AESL_DEBUG_TRACE)
printf("\n  %%126 = lshr i64 %%123, %%125, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_520_count);
  llvm_cbe_tmp__113 = (unsigned long long )((unsigned long long )(((unsigned long long )(llvm_cbe_tmp__110&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__112&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__113&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%127 = trunc i64 %%126 to i8, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_521_count);
  llvm_cbe_tmp__114 = (unsigned char )((unsigned char )llvm_cbe_tmp__113&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__114);
if (AESL_DEBUG_TRACE)
printf("\n  %%128 = sext i8 %%127 to i32, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_526_count);
  llvm_cbe_tmp__115 = (unsigned int )((signed int )( char )llvm_cbe_tmp__114);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__115);
if (AESL_DEBUG_TRACE)
printf("\n  %%129 = lshr i32 %%128, 4, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_527_count);
  llvm_cbe_tmp__116 = (unsigned int )((unsigned int )(((unsigned int )(llvm_cbe_tmp__115&4294967295ull)) >> ((unsigned int )(4u&4294967295ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__116&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%130 = zext i8 %%127 to i32, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_528_count);
  llvm_cbe_tmp__117 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__114&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__117);
if (AESL_DEBUG_TRACE)
printf("\n  %%131 = and i32 %%130, 1, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_529_count);
  llvm_cbe_tmp__118 = (unsigned int )llvm_cbe_tmp__117 & 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__118);
if (AESL_DEBUG_TRACE)
printf("\n  %%132 = or i32 %%129, %%131, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_530_count);
  llvm_cbe_tmp__119 = (unsigned int )llvm_cbe_tmp__116 | llvm_cbe_tmp__118;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__119);
if (AESL_DEBUG_TRACE)
printf("\n  %%133 = trunc i32 %%132 to i8, !dbg !16 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_531_count);
  llvm_cbe_tmp__120 = (unsigned char )((unsigned char )llvm_cbe_tmp__119&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__120);
if (AESL_DEBUG_TRACE)
printf("\n  %%134 = lshr i64 131941395333120, %%121, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_536_count);
  llvm_cbe_tmp__121 = (unsigned long long )((unsigned long long )(((unsigned long long )(131941395333120ull&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__108&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__121&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%135 = and i64 %%134, %%115, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_537_count);
  llvm_cbe_tmp__122 = (unsigned long long )llvm_cbe_tmp__121 & llvm_cbe_tmp__103;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__122);
if (AESL_DEBUG_TRACE)
printf("\n  %%136 = sub nsw i32 43, %%120, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_538_count);
  llvm_cbe_tmp__123 = (unsigned int )((unsigned int )(43u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__107&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__123&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%137 = zext i32 %%136 to i64, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_539_count);
  llvm_cbe_tmp__124 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__123&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__124);
if (AESL_DEBUG_TRACE)
printf("\n  %%138 = lshr i64 %%135, %%137, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_540_count);
  llvm_cbe_tmp__125 = (unsigned long long )((unsigned long long )(((unsigned long long )(llvm_cbe_tmp__122&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__124&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__125&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%139 = trunc i64 %%138 to i8, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_541_count);
  llvm_cbe_tmp__126 = (unsigned char )((unsigned char )llvm_cbe_tmp__125&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__126);
if (AESL_DEBUG_TRACE)
printf("\n  %%140 = shl i32 %%117, 4, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_544_count);
  llvm_cbe_tmp__127 = (unsigned int )llvm_cbe_tmp__104 << 4u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__127);
if (AESL_DEBUG_TRACE)
printf("\n  %%141 = sext i8 %%133 to i32, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_549_count);
  llvm_cbe_tmp__128 = (unsigned int )((signed int )( char )llvm_cbe_tmp__120);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__128);
if (AESL_DEBUG_TRACE)
printf("\n  %%142 = shl nsw i32 %%141, 4, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_550_count);
  llvm_cbe_tmp__129 = (unsigned int )llvm_cbe_tmp__128 << 4u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__129);
if (AESL_DEBUG_TRACE)
printf("\n  %%143 = sext i8 %%139 to i32, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_551_count);
  llvm_cbe_tmp__130 = (unsigned int )((signed int )( char )llvm_cbe_tmp__126);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__130);
if (AESL_DEBUG_TRACE)
printf("\n  %%144 = add nsw i32 %%142, %%143, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_552_count);
  llvm_cbe_tmp__131 = (unsigned int )((unsigned int )(llvm_cbe_tmp__129&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__130&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__131&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%145 = sext i32 %%144 to i64, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_553_count);
  llvm_cbe_tmp__132 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__131);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__132);
if (AESL_DEBUG_TRACE)
printf("\n  %%146 = sext i32 %%storemerge620 to i64, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_554_count);
  llvm_cbe_tmp__133 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge620);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__133);
if (AESL_DEBUG_TRACE)
printf("\n  %%147 = getelementptr inbounds [8 x [64 x i8]]* @aesl_internal_des_dec.S, i64 0, i64 %%146, i64 %%145, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_555_count);
  llvm_cbe_tmp__134 = ( char *)(&aesl_internal_des_dec_OC_S[(((signed long long )llvm_cbe_tmp__133))
#ifdef AESL_BC_SIM
 % 8
#endif
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__133) < 8)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_des_dec.S' bound?\n", __FILE__, __LINE__);
  if (!(((signed long long )llvm_cbe_tmp__132) < 64)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_des_dec.S' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%148 = load i8* %%147, align 1, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_556_count);
  llvm_cbe_tmp__135 = (unsigned char )*llvm_cbe_tmp__134;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__135);
if (AESL_DEBUG_TRACE)
printf("\n  %%149 = zext i8 %%148 to i32, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_557_count);
  llvm_cbe_tmp__136 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__135&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__136);
if (AESL_DEBUG_TRACE)
printf("\n  %%150 = and i32 %%149, 15, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_558_count);
  llvm_cbe_tmp__137 = (unsigned int )llvm_cbe_tmp__136 & 15u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__137);
if (AESL_DEBUG_TRACE)
printf("\n  %%151 = or i32 %%150, %%140, !dbg !9 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_559_count);
  llvm_cbe_tmp__138 = (unsigned int )llvm_cbe_tmp__137 | llvm_cbe_tmp__127;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__138);
if (AESL_DEBUG_TRACE)
printf("\n  %%152 = add nsw i32 %%storemerge620, 1, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_564_count);
  llvm_cbe_tmp__139 = (unsigned int )((unsigned int )(llvm_cbe_storemerge620&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__139&4294967295ull)));
  if (((llvm_cbe_tmp__139&4294967295U) == (8u&4294967295U))) {
    llvm_cbe_storemerge718__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
    llvm_cbe_tmp__140__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
    goto llvm_cbe__2e_preheader;
  } else {
    llvm_cbe_storemerge620__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__139;   /* for PHI node */
    llvm_cbe_tmp__104__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__138;   /* for PHI node */
...
llvm_cbe_tmp__183:
if (AESL_DEBUG_TRACE)
printf("\n  %%111 = sub nsw i32 15, %%storemerge327, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_478_count);
  llvm_cbe_tmp__99 = (unsigned int )((unsigned int )(15u&4294967295ull)) - ((unsigned int )(llvm_cbe_storemerge327&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__99&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%112 = sext i32 %%111 to i64, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_479_count);
  llvm_cbe_tmp__100 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__99);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__100);
if (AESL_DEBUG_TRACE)
printf("\n  %%113 = getelementptr inbounds [16 x i64]* %%sub_key, i64 0, i64 %%112, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_480_count);
  llvm_cbe_tmp__101 = (signed long long *)(&llvm_cbe_sub_key[(((signed long long )llvm_cbe_tmp__100))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__100) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'sub_key' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%114 = load i64* %%113, align 8, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_481_count);
  llvm_cbe_tmp__102 = (unsigned long long )*llvm_cbe_tmp__101;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__102);
if (AESL_DEBUG_TRACE)
printf("\n  %%115 = xor i64 %%114, %%108, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_482_count);
  llvm_cbe_tmp__103 = (unsigned long long )llvm_cbe_tmp__102 ^ llvm_cbe_tmp__97;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__103);
  llvm_cbe_storemerge620__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
  llvm_cbe_tmp__104__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__86;   /* for PHI node */
  goto llvm_cbe_tmp__182;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__179:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge523 = phi i32 [ 0, %%.preheader21 ], [ %%109, %%97  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_storemerge523_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%98 = phi i64 [ 0, %%.preheader21 ], [ %%108, %%97  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_432_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%99 = shl i64 %%98, 1, !dbg !15 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_433_count);
  llvm_cbe_tmp__88 = (unsigned long long )llvm_cbe_tmp__87 << 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__88);
if (AESL_DEBUG_TRACE)
printf("\n  %%100 = sext i32 %%storemerge523 to i64, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_440_count);
  llvm_cbe_tmp__89 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge523);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__89);
if (AESL_DEBUG_TRACE)
printf("\n  %%101 = getelementptr inbounds [48 x i8]* @aesl_internal_des_dec.E, i64 0, i64 %%100, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_441_count);
  llvm_cbe_tmp__90 = ( char *)(&aesl_internal_des_dec_OC_E[(((signed long long )llvm_cbe_tmp__89))
#ifdef AESL_BC_SIM
 % 48
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__89) < 48)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_des_dec.E' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%102 = load i8* %%101, align 1, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_442_count);
  llvm_cbe_tmp__91 = (unsigned char )*llvm_cbe_tmp__90;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__91);
if (AESL_DEBUG_TRACE)
printf("\n  %%103 = sext i8 %%102 to i32, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_443_count);
  llvm_cbe_tmp__92 = (unsigned int )((signed int )( char )llvm_cbe_tmp__91);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__92);
if (AESL_DEBUG_TRACE)
printf("\n  %%104 = sub nsw i32 32, %%103, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_444_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%105 = lshr i32 %%95, %%104, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_445_count);
...
llvm_cbe_tmp__181:
if (AESL_DEBUG_TRACE)
printf("\n  %%168 = zext i32 %%165 to i64, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_654_count);
  llvm_cbe_tmp__153 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__151&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__153);
if (AESL_DEBUG_TRACE)
printf("\n  %%169 = shl nuw i64 %%168, 32, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_655_count);
  llvm_cbe_tmp__154 = (unsigned long long )llvm_cbe_tmp__153 << 32ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__154);
if (AESL_DEBUG_TRACE)
printf("\n  %%170 = zext i32 %%95 to i64, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_656_count);
  llvm_cbe_tmp__155 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__85&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__155);
if (AESL_DEBUG_TRACE)
printf("\n  %%171 = or i64 %%169, %%170, !dbg !8 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_657_count);
  llvm_cbe_tmp__156 = (unsigned long long )llvm_cbe_tmp__154 | llvm_cbe_tmp__155;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__156);
  llvm_cbe_storemerge416__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
  llvm_cbe_tmp__157__PHI_TEMPORARY = (unsigned long long )0ull;   /* for PHI node */
  goto llvm_cbe_tmp__184;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__184:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge416 = phi i32 [ 0, %%167 ], [ %%184, %%172  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_storemerge416_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%173 = phi i64 [ 0, %%167 ], [ %%183, %%172  for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_683_count);
  llvm_cbe_tmp__157 = (unsigned long long )llvm_cbe_tmp__157__PHI_TEMPORARY;
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%174 = shl i64 %%173, 1, !dbg !11 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_684_count);
  llvm_cbe_tmp__158 = (unsigned long long )llvm_cbe_tmp__157 << 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__158);
if (AESL_DEBUG_TRACE)
printf("\n  %%175 = sext i32 %%storemerge416 to i64, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_689_count);
  llvm_cbe_tmp__159 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge416);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__159);
if (AESL_DEBUG_TRACE)
printf("\n  %%176 = getelementptr inbounds [64 x i8]* @aesl_internal_des_dec.PI, i64 0, i64 %%175, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_690_count);
  llvm_cbe_tmp__160 = ( char *)(&aesl_internal_des_dec_OC_PI[(((signed long long )llvm_cbe_tmp__159))
#ifdef AESL_BC_SIM
 % 64
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__159) < 64)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_des_dec.PI' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%177 = load i8* %%176, align 1, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_691_count);
  llvm_cbe_tmp__161 = (unsigned char )*llvm_cbe_tmp__160;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__161);
if (AESL_DEBUG_TRACE)
printf("\n  %%178 = sext i8 %%177 to i32, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_692_count);
  llvm_cbe_tmp__162 = (unsigned int )((signed int )( char )llvm_cbe_tmp__161);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__162);
if (AESL_DEBUG_TRACE)
printf("\n  %%179 = sub nsw i32 64, %%178, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_693_count);
  llvm_cbe_tmp__163 = (unsigned int )((unsigned int )(64u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__162&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__163&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%180 = zext i32 %%179 to i64, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_694_count);
  llvm_cbe_tmp__164 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__163&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__164);
if (AESL_DEBUG_TRACE)
printf("\n  %%181 = lshr i64 %%171, %%180, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_695_count);
  llvm_cbe_tmp__165 = (unsigned long long )((unsigned long long )(((unsigned long long )(llvm_cbe_tmp__156&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__164&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__165&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%182 = and i64 %%181, 1, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_696_count);
  llvm_cbe_tmp__166 = (unsigned long long )llvm_cbe_tmp__165 & 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__166);
if (AESL_DEBUG_TRACE)
printf("\n  %%183 = or i64 %%182, %%174, !dbg !12 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_697_count);
  llvm_cbe_tmp__167 = (unsigned long long )llvm_cbe_tmp__166 | llvm_cbe_tmp__158;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__167);
if (AESL_DEBUG_TRACE)
printf("\n  %%184 = add nsw i32 %%storemerge416, 1, !dbg !14 for 0x%I64xth hint within @des_dec  --> \n", ++aesl_llvm_cbe_702_count);
  llvm_cbe_tmp__168 = (unsigned int )((unsigned int )(llvm_cbe_storemerge416&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__168&4294967295ull)));
  if (((llvm_cbe_tmp__168&4294967295U) == (64u&4294967295U))) {
    goto llvm_cbe_tmp__185;
  } else {
    llvm_cbe_storemerge416__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__168;   /* for PHI node */
    llvm_cbe_tmp__157__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__167;   /* for PHI node */
    goto llvm_cbe_tmp__184;
  }
