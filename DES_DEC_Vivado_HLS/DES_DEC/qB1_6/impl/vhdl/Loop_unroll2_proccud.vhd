...
entity Loop_unroll2_proccud_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 56
...
architecture rtl of Loop_unroll2_proccud_rom is 
...
entity Loop_unroll2_proccud is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of Loop_unroll2_proccud is
    component Loop_unroll2_proccud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_unroll2_proccud_rom_U :  component Loop_unroll2_proccud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
