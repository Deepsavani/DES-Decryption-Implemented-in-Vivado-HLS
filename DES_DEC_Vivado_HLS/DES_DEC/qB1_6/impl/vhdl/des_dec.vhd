...
architecture behav of des_dec is 
    ...
    "des_dec,hls_ip_2019_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a35tl-cpg236-2L,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.117375,HLS_SYN_LAT=166,HLS_SYN_TPT=67,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=883,HLS_SYN_LUT=2769,HLS_VERSION=2019_1}";
    ...
    signal sub_key_i_q0 : STD_LOGIC_VECTOR (47 downto 0);
    signal sub_key_t_q0 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal Loop_loop3_proc_U0_sub_key_d0 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal tmp_p_desDecrypt_c_line2_fu_141_ap_return : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component start_for_Loop_uneOg IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Loop_unfYi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    start_for_Loop_uneOg_U : component start_for_Loop_uneOg
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_unfYi_U : component start_for_Loop_unfYi
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
