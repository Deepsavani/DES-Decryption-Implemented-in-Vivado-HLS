...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module Loop_Pipeline_loodEe_rom (
...
initial begin
    $readmemh("./Loop_Pipeline_loodEe_rom.dat", ram0);
    $readmemh("./Loop_Pipeline_loodEe_rom.dat", ram1);
    $readmemh("./Loop_Pipeline_loodEe_rom.dat", ram2);
    $readmemh("./Loop_Pipeline_loodEe_rom.dat", ram3);
end
...
Loop_Pipeline_loodEe_rom Loop_Pipeline_loodEe_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
