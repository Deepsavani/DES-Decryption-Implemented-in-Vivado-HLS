...
const sc_lv<48> des_dec::ap_const_lv48_0 = "000000000000000000000000000000000000000000000000";
...
des_dec::des_dec(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sub_key_U->i_address0(Loop_loop3_proc_U0_sub_key_address0);
    sub_key_U->i_ce0(Loop_loop3_proc_U0_sub_key_ce0);
    sub_key_U->i_we0(Loop_loop3_proc_U0_sub_key_we0);
    sub_key_U->i_d0(Loop_loop3_proc_U0_sub_key_d0);
    ...
    sub_key_U->i_write(Loop_loop3_proc_U0_ap_done);
    ...
    Loop_loop3_proc_U0->p_read(permuted_choice_1_0_1_dout);
    Loop_loop3_proc_U0->p_read1(permuted_choice_1_0_s_dout);
    Loop_loop3_proc_U0->sub_key_address0(Loop_loop3_proc_U0_sub_key_address0);
    Loop_loop3_proc_U0->sub_key_ce0(Loop_loop3_proc_U0_sub_key_ce0);
    Loop_loop3_proc_U0->sub_key_we0(Loop_loop3_proc_U0_sub_key_we0);
    Loop_loop3_proc_U0->sub_key_d0(Loop_loop3_proc_U0_sub_key_d0);
    ...
    Loop_loop5_proc_U0 = new Loop_loop5_proc("Loop_loop5_proc_U0");
    Loop_loop5_proc_U0->ap_clk(ap_clk);
    Loop_loop5_proc_U0->ap_rst(ap_rst);
    Loop_loop5_proc_U0->ap_start(Loop_loop5_proc_U0_ap_start);
    Loop_loop5_proc_U0->ap_done(Loop_loop5_proc_U0_ap_done);
    Loop_loop5_proc_U0->ap_continue(Loop_loop5_proc_U0_ap_continue);
    Loop_loop5_proc_U0->ap_idle(Loop_loop5_proc_U0_ap_idle);
    Loop_loop5_proc_U0->ap_ready(Loop_loop5_proc_U0_ap_ready);
    Loop_loop5_proc_U0->p_read(temp_loc_channel_dout);
    Loop_loop5_proc_U0->p_read1(L_0_loc_channel_dout);
    Loop_loop5_proc_U0->ap_return(Loop_loop5_proc_U0_ap_return);
    ...
    permuted_choice_1_0_s_U->if_read(Loop_loop3_proc_U0_ap_ready);
    ...
    permuted_choice_1_0_1_U->if_read(Loop_loop3_proc_U0_ap_ready);
    ...
    temp_loc_channel_U->if_read(Loop_loop5_proc_U0_ap_ready);
    ...
    L_0_loc_channel_U->if_read(Loop_loop5_proc_U0_ap_ready);
    ...
    inv_init_perm_res_0_s_U->if_din(Loop_loop5_proc_U0_ap_return);
    inv_init_perm_res_0_s_U->if_full_n(inv_init_perm_res_0_s_full_n);
    inv_init_perm_res_0_s_U->if_write(Loop_loop5_proc_U0_ap_done);
    ...
    start_for_Loop_uneOg_U = new start_for_Loop_uneOg("start_for_Loop_uneOg_U");
    start_for_Loop_uneOg_U->clk(ap_clk);
    start_for_Loop_uneOg_U->reset(ap_rst);
    start_for_Loop_uneOg_U->if_read_ce(ap_var_for_const2);
    start_for_Loop_uneOg_U->if_write_ce(ap_var_for_const2);
    start_for_Loop_uneOg_U->if_din(start_for_Loop_unroll1_proc_U0_din);
    start_for_Loop_uneOg_U->if_full_n(start_for_Loop_unroll1_proc_U0_full_n);
    start_for_Loop_uneOg_U->if_write(des_dec_entry7_U0_start_write);
    start_for_Loop_uneOg_U->if_dout(start_for_Loop_unroll1_proc_U0_dout);
    start_for_Loop_uneOg_U->if_empty_n(start_for_Loop_unroll1_proc_U0_empty_n);
    start_for_Loop_uneOg_U->if_read(Loop_unroll1_proc_U0_ap_ready);
    start_for_Loop_unfYi_U = new start_for_Loop_unfYi("start_for_Loop_unfYi_U");
    start_for_Loop_unfYi_U->clk(ap_clk);
    start_for_Loop_unfYi_U->reset(ap_rst);
    start_for_Loop_unfYi_U->if_read_ce(ap_var_for_const2);
    start_for_Loop_unfYi_U->if_write_ce(ap_var_for_const2);
    start_for_Loop_unfYi_U->if_din(start_for_Loop_unroll2_proc_U0_din);
    start_for_Loop_unfYi_U->if_full_n(start_for_Loop_unroll2_proc_U0_full_n);
    start_for_Loop_unfYi_U->if_write(des_dec_entry7_U0_start_write);
    start_for_Loop_unfYi_U->if_dout(start_for_Loop_unroll2_proc_U0_dout);
    start_for_Loop_unfYi_U->if_empty_n(start_for_Loop_unroll2_proc_U0_empty_n);
    start_for_Loop_unfYi_U->if_read(Loop_unroll2_proc_U0_ap_ready);
    ...
    SC_METHOD(thread_Loop_loop3_proc_U0_sub_key_full_n);
    sensitive << ( sub_key_i_full_n );

    SC_METHOD(thread_Loop_loop5_proc_U0_ap_continue);
    sensitive << ( inv_init_perm_res_0_s_full_n );

    SC_METHOD(thread_Loop_loop5_proc_U0_ap_start);
    sensitive << ( temp_loc_channel_empty_n );
    sensitive << ( L_0_loc_channel_empty_n );

    SC_METHOD(thread_Loop_loop5_proc_U0_start_full_n);

    SC_METHOD(thread_Loop_loop5_proc_U0_start_write);
    ...
    sensitive << ( Loop_loop5_proc_U0_ap_done );
    ...
    sensitive << ( Loop_loop5_proc_U0_ap_idle );
    ...
    SC_METHOD(thread_tmp_p_desDecrypt_c_line2_fu_141_ap_return);
    ...
    sc_trace(mVcdFile, Loop_loop3_proc_U0_sub_key_address0, "Loop_loop3_proc_U0_sub_key_address0");
    sc_trace(mVcdFile, Loop_loop3_proc_U0_sub_key_ce0, "Loop_loop3_proc_U0_sub_key_ce0");
    sc_trace(mVcdFile, Loop_loop3_proc_U0_sub_key_we0, "Loop_loop3_proc_U0_sub_key_we0");
    sc_trace(mVcdFile, Loop_loop3_proc_U0_sub_key_d0, "Loop_loop3_proc_U0_sub_key_d0");
    sc_trace(mVcdFile, ap_channel_done_sub_key, "ap_channel_done_sub_key");
    sc_trace(mVcdFile, Loop_loop3_proc_U0_sub_key_full_n, "Loop_loop3_proc_U0_sub_key_full_n");
    ...
    sc_trace(mVcdFile, Loop_loop5_proc_U0_ap_start, "Loop_loop5_proc_U0_ap_start");
    sc_trace(mVcdFile, Loop_loop5_proc_U0_ap_done, "Loop_loop5_proc_U0_ap_done");
    sc_trace(mVcdFile, Loop_loop5_proc_U0_ap_continue, "Loop_loop5_proc_U0_ap_continue");
    sc_trace(mVcdFile, Loop_loop5_proc_U0_ap_idle, "Loop_loop5_proc_U0_ap_idle");
    sc_trace(mVcdFile, Loop_loop5_proc_U0_ap_ready, "Loop_loop5_proc_U0_ap_ready");
    sc_trace(mVcdFile, Loop_loop5_proc_U0_ap_return, "Loop_loop5_proc_U0_ap_return");
    ...
    sc_trace(mVcdFile, tmp_p_desDecrypt_c_line2_fu_141_ap_return, "tmp_p_desDecrypt_c_line2_fu_141_ap_return");
    ...
    sc_trace(mVcdFile, Loop_loop5_proc_U0_start_full_n, "Loop_loop5_proc_U0_start_full_n");
    sc_trace(mVcdFile, Loop_loop5_proc_U0_start_write, "Loop_loop5_proc_U0_start_write");
...
des_dec::~des_dec() {
    ...
    delete start_for_Loop_uneOg_U;
    delete start_for_Loop_unfYi_U;
}
...
void des_dec::thread_ap_var_for_const1() {
    ap_var_for_const1 = ap_const_lv48_0;
}
...
void des_dec::thread_Loop_loop3_proc_U0_ap_continue() {
    Loop_loop3_proc_U0_ap_continue = sub_key_i_full_n.read();
}

void des_dec::thread_Loop_loop3_proc_U0_ap_start() {
    Loop_loop3_proc_U0_ap_start = (permuted_choice_1_0_s_empty_n.read() & permuted_choice_1_0_1_empty_n.read());
}

void des_dec::thread_Loop_loop3_proc_U0_start_full_n() {
    Loop_loop3_proc_U0_start_full_n = ap_const_logic_1;
}

void des_dec::thread_Loop_loop3_proc_U0_start_write() {
    Loop_loop3_proc_U0_start_write = ap_const_logic_0;
}

void des_dec::thread_Loop_loop3_proc_U0_sub_key_full_n() {
    Loop_loop3_proc_U0_sub_key_full_n = sub_key_i_full_n.read();
}

void des_dec::thread_Loop_loop5_proc_U0_ap_continue() {
    Loop_loop5_proc_U0_ap_continue = inv_init_perm_res_0_s_full_n.read();
}

void des_dec::thread_Loop_loop5_proc_U0_ap_start() {
    Loop_loop5_proc_U0_ap_start = (temp_loc_channel_empty_n.read() & L_0_loc_channel_empty_n.read());
}

void des_dec::thread_Loop_loop5_proc_U0_start_full_n() {
    Loop_loop5_proc_U0_start_full_n = ap_const_logic_1;
}

void des_dec::thread_Loop_loop5_proc_U0_start_write() {
...
void des_dec::thread_ap_channel_done_inv_init_perm_res_0_s() {
    ap_channel_done_inv_init_perm_res_0_s = Loop_loop5_proc_U0_ap_done.read();
}
...
void des_dec::thread_ap_channel_done_sub_key() {
    ap_channel_done_sub_key = Loop_loop3_proc_U0_ap_done.read();
}
...
void des_dec::thread_ap_idle() {
    ap_idle = (des_dec_entry7_U0_ap_idle.read() & Loop_unroll1_proc_U0_ap_idle.read() & Block_des_dec_exit2_U0_ap_idle.read() & Loop_unroll2_proc_U0_ap_idle.read() & Loop_loop3_proc_U0_ap_idle.read() & Loop_Pipeline_loop4_U0_ap_idle.read() & Loop_loop5_proc_U0_ap_idle.read() & p_desDecrypt_c_line2_U0_ap_idle.read() & (init_perm_res_0_loc_s_empty_n.read() ^ 
...
void des_dec::thread_tmp_p_desDecrypt_c_line2_fu_141_ap_return() {
    tmp_p_desDecrypt_c_line2_fu_141_ap_return = ap_const_lv64_0;
}
