...
#include "start_for_Loop_uneOg.h"
#include "start_for_Loop_unfYi.h"
...
struct des_dec : public sc_module {
    ...
    sc_signal< sc_lv<48> > ap_var_for_const1;
    ...
    sc_signal< sc_lv<48> > sub_key_i_q0;
    sc_signal< sc_lv<48> > sub_key_t_q0;
    ...
    sc_signal< sc_lv<4> > Loop_loop3_proc_U0_sub_key_address0;
    sc_signal< sc_logic > Loop_loop3_proc_U0_sub_key_ce0;
    sc_signal< sc_logic > Loop_loop3_proc_U0_sub_key_we0;
    sc_signal< sc_lv<48> > Loop_loop3_proc_U0_sub_key_d0;
    sc_signal< sc_logic > ap_channel_done_sub_key;
    sc_signal< sc_logic > Loop_loop3_proc_U0_sub_key_full_n;
    ...
    sc_signal< sc_logic > Loop_loop5_proc_U0_ap_start;
    sc_signal< sc_logic > Loop_loop5_proc_U0_ap_done;
    sc_signal< sc_logic > Loop_loop5_proc_U0_ap_continue;
    sc_signal< sc_logic > Loop_loop5_proc_U0_ap_idle;
    sc_signal< sc_logic > Loop_loop5_proc_U0_ap_ready;
    sc_signal< sc_lv<64> > Loop_loop5_proc_U0_ap_return;
    ...
    sc_signal< sc_lv<64> > tmp_p_desDecrypt_c_line2_fu_141_ap_return;
    ...
    sc_signal< sc_logic > Loop_loop5_proc_U0_start_full_n;
    sc_signal< sc_logic > Loop_loop5_proc_U0_start_write;
    ...
    void thread_Loop_loop3_proc_U0_sub_key_full_n();
    void thread_Loop_loop5_proc_U0_ap_continue();
    void thread_Loop_loop5_proc_U0_ap_start();
    void thread_Loop_loop5_proc_U0_start_full_n();
    void thread_Loop_loop5_proc_U0_start_write();
    ...
    void thread_tmp_p_desDecrypt_c_line2_fu_141_ap_return();
