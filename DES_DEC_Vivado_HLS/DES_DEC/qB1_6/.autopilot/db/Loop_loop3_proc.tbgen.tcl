...
set portList { 
	...
	{ sub_key_d0 sc_out sc_lv 48 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_key_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "sub_key", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sub_key { ap_memory {  { sub_key_address0 mem_address 1 4 }  { sub_key_ce0 mem_ce 1 1 }  { sub_key_we0 mem_we 1 1 }  { sub_key_d0 mem_din 1 48 } } }
}
