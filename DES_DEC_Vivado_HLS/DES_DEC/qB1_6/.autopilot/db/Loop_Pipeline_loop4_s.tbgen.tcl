...
set C_modelArgList {
	...
	{ sub_key int 48 regular {array 16 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "p_read1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sub_key", "interface" : "memory", "bitwidth" : 48, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub_key_q0 sc_in sc_lv 48 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_key_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "sub_key", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	sub_key { ap_memory {  { sub_key_address0 mem_address 1 4 }  { sub_key_ce0 mem_ce 1 1 }  { sub_key_q0 mem_dout 0 48 } } }
}
