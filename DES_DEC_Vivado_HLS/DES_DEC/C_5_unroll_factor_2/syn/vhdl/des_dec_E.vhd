...
architecture rtl of des_dec_E_rom is 
...
architecture arch of des_dec_E is
    component des_dec_E_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    des_dec_E_rom_U :  component des_dec_E_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
