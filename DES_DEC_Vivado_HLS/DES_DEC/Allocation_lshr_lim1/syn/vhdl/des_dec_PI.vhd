...
architecture rtl of des_dec_PI_rom is 
...
architecture arch of des_dec_PI is
    component des_dec_PI_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    des_dec_PI_rom_U :  component des_dec_PI_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
