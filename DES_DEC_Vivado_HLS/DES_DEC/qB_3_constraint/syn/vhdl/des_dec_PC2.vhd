...
architecture rtl of des_dec_PC2_rom is 
...
architecture arch of des_dec_PC2 is
    component des_dec_PC2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    des_dec_PC2_rom_U :  component des_dec_PC2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
