...
architecture rtl of des_dec_P_rom is 
...
architecture arch of des_dec_P is
    component des_dec_P_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    des_dec_P_rom_U :  component des_dec_P_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
