...
void des_dec_sub_key::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void des_dec_sub_key::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void des_dec_sub_key::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void des_dec_sub_key::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
