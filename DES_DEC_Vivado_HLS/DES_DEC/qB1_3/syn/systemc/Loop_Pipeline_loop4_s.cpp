...
Loop_Pipeline_loop4_s::Loop_Pipeline_loop4_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_s_fu_553_p4);
    ...
    sc_trace(mVcdFile, tmp_s_fu_553_p4, "tmp_s_fu_553_p4");
...
void Loop_Pipeline_loop4_s::thread_sext_ln246_fu_563_p1() {
    sext_ln246_fu_563_p1 = esl_sext<9,8>(tmp_s_fu_553_p4.read());
}
...
void Loop_Pipeline_loop4_s::thread_tmp_1_fu_577_p3() {
    tmp_1_fu_577_p3 = esl_concat<4,6>(j_2_i_reg_228.read(), ap_const_lv6_0);
}

void Loop_Pipeline_loop4_s::thread_tmp_6_fu_515_p4() {
    tmp_6_fu_515_p4 = lshr_ln240_1_fu_491_p2.read().range(7, 5);
}
...
void Loop_Pipeline_loop4_s::thread_tmp_s_fu_553_p4() {
    tmp_s_fu_553_p4 = esl_concat<4,4>(esl_concat<3,1>(tmp_6_fu_515_p4.read(), or_ln241_fu_509_p2.read()), ap_const_lv4_0);
}
...
void Loop_Pipeline_loop4_s::thread_zext_ln246_fu_585_p1() {
    zext_ln246_fu_585_p1 = esl_zext<11,10>(tmp_1_fu_577_p3.read());
}
