...
entity Loop_unroll1_procbkb_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of Loop_unroll1_procbkb_rom is 
...
entity Loop_unroll1_procbkb is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of Loop_unroll1_procbkb is
    component Loop_unroll1_procbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_unroll1_procbkb_rom_U :  component Loop_unroll1_procbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
