...
entity Loop_loop5_proc_PI_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of Loop_loop5_proc_PI_rom is 
...
architecture arch of Loop_loop5_proc_PI is
    component Loop_loop5_proc_PI_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_loop5_proc_PI_rom_U :  component Loop_loop5_proc_PI_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
