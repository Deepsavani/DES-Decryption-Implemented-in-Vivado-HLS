...
architecture behav of des_dec is 
    ...
    signal Loop_3_proc_U0_sub_key_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal Loop_3_proc_U0_sub_key_ce0 : STD_LOGIC;
    signal Loop_3_proc_U0_sub_key_we0 : STD_LOGIC;
    signal Loop_3_proc_U0_sub_key_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_channel_done_sub_key : STD_LOGIC;
    signal Loop_3_proc_U0_sub_key_full_n : STD_LOGIC;
    ...
    signal Loop_5_proc_U0_ap_return : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_p_desDecrypt_c_line2_fu_153_ap_return : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    Loop_3_proc_U0_ap_continue <= sub_key_i_full_n;
    Loop_3_proc_U0_ap_start <= (permuted_choice_1_0_s_empty_n and permuted_choice_1_0_1_empty_n);
    Loop_3_proc_U0_start_full_n <= ap_const_logic_1;
    Loop_3_proc_U0_start_write <= ap_const_logic_0;
    Loop_3_proc_U0_sub_key_full_n <= sub_key_i_full_n;
    Loop_5_proc_U0_ap_continue <= inv_init_perm_res_0_s_full_n;
    Loop_5_proc_U0_ap_start <= (temp_loc_channel_empty_n and L_0_loc_channel_empty_n);
    ...
    ap_channel_done_inv_init_perm_res_0_s <= Loop_5_proc_U0_ap_done;
    ...
    ap_channel_done_sub_key <= Loop_3_proc_U0_ap_done;
