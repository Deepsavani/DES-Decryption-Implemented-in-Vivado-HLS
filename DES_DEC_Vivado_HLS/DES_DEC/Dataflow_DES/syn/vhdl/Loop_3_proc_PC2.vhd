...
architecture rtl of Loop_3_proc_PC2_rom is 
...
architecture arch of Loop_3_proc_PC2 is
    component Loop_3_proc_PC2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_3_proc_PC2_rom_U :  component Loop_3_proc_PC2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
