set moduleName Loop_Pipeline_loop4_s
set isTopModule 0
...
set C_modelName {Loop_Pipeline_loop4_}
set C_modelType { int 64 }
set C_modelArgList {
	{ p_read int 32 regular  }
	{ p_read1 int 32 regular  }
	{ sub_key int 64 regular {array 16 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "p_read1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sub_key", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub_key_q0 sc_in sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_key_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "sub_key", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "sub_key", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3153", "Max" : "3153"}
	, {"Name" : "Interval", "Min" : "3153", "Max" : "3153"}
]}
...
set Spec2ImplPortList { 
	...
	sub_key { ap_memory {  { sub_key_address0 mem_address 1 4 }  { sub_key_ce0 mem_ce 1 1 }  { sub_key_q0 mem_dout 0 64 } } }
}
